 ...
 *
 * parseJsonBody — lifted verbatim from @vibe-llm/provider-copilot/src/provider.ts.
 ...
 *
 * truncateBody — extracted from @vibe-llm/provider-copilot/src/forward.ts:85-88.
