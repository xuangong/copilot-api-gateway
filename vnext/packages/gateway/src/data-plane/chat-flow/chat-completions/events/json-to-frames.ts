 ...
 */
import { doneFrame, eventFrame, type ProtocolFrame } from '@vnext/protocols/common'
import type { ChatCompletionsStreamEvent, ChatCompletionsDelta } from '@vnext/protocols/chat'
