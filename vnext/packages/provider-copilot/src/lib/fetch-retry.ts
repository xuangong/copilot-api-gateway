 ...
 */
// Note: gateway's fetch-retry.ts also imports HTTPError for the helper
// `fetchJSON`. That helper is unused by the Copilot data plane, so it (and
// the import) are dropped here.
