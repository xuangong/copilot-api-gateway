...
const COPILOT_MODEL_PRICING: readonly PricingRule[] = [
  ...
  ["gpt-5.6-terra", { input: 2.5, input_cache_read: 0.25, input_cache_write: 3.125, output: 15 }],
  ["gpt-5.6-luna", { input: 1, input_cache_read: 0.1, input_cache_write: 1.25, output: 6 }],
