...
const COPILOT_MODEL_PRICING: readonly PricingRule[] = [
  ...
  [/^claude-opus-5([.-]\d)?$/, { input: 5, input_cache_read: 0.5, input_cache_write: 6.25, output: 25 }],
  ...
  [/^claude-fable-5([.-]\d)?$/, { input: 10, input_cache_read: 1, input_cache_write: 12.5, output: 50 }],
  [/^claude-haiku-4[.-]5$/, { input: 1, input_cache_read: 0.1, input_cache_write: 1.25, output: 5 }],
  ["gpt-5.6-sol", { input: 5, input_cache_read: 0.5, input_cache_write: 6.25, output: 30 }],
  ["gpt-5.6-terra", { input: 2, input_cache_read: 0.2, input_cache_write: 2.5, output: 12 }],
  ["gpt-5.6-luna", { input: 0.2, input_cache_read: 0.02, input_cache_write: 0.25, output: 1.2 }],
  ...
  ["gemini-3.6-flash", { input: 1.5, input_cache_read: 0.15, output: 7.5 }],
  [/^grok-code-fast/, { input: 0.2, output: 1.5 }],
  [/^grok-4[.]5/, { input: 2, input_cache_read: 0.5, output: 6 }],
  [/^mai-code-1-flash/, { input: 0.75, input_cache_read: 0.075, output: 4.5 }],
  [/^kimi-k2[.]7-code/, { input: 0.95, input_cache_read: 0.19, output: 4 }],
  [/^kimi-k3/, { input: 3, input_cache_read: 0.3, output: 15 }],
