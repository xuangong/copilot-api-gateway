/**
 * Ported 1:1 from copilot-gateway packages/protocols/src/images/index.ts.
 *
 * OpenAI /v1/images/generations and /v1/images/edits payload shapes used
 * by the responses image_generation server-tool shim.
 */
